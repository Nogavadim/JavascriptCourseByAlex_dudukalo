...
let heightTh = document.createElement("th") // создание высоты
let actionTh = document.createElement("th")

nameTh.textContent = "Имя"
ageTh.textContent = "Возраст"
heightTh.textContent = "Рост" //добавил Рост
actionTh.textContent = "Действие"

theadTr.append(nameTh, ageTh, heightTh, actionTh) //добавил Рост
...
function getStudentTr(name, age, height) {
  ...
  let heightTD = document.createElement("td") //добавил Рост
