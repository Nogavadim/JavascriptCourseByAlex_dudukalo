...
let index = 1 
let productPriceItog1 = productCount1 * productPrice1
...
index = index + 1
let productPriceItog2 = productCount2 * productPrice2
...
index = index + 1
let productPriceItog3 = productCount3 * productPrice3
...
document.write(`<tr>
                  ...
                  <td>${productCount3}</td>
                  <td>${productPrice3}</td>
                  <td>${productPriceItog3}</td>
                </tr>`)

let sumPurchase = productPriceItog1 + productPriceItog2 + productPriceItog3
