...
function card (product, price, discount) {
  printParagraph(`${index++} ) ${product}, стоимость: ${price} -  ${discount}% =  ${getStrong(getPercentDiscount(price, discount)) }  руб. `)
}


card('Штаны', 1000, 20)
card('Футболка', 1500, 10)
card('Кепка', 3000, 25)
