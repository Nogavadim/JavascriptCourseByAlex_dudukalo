...
sendBox.append(emailInp, msgText, sendBtn) // Добавление в sendBox
...
sendBtn.onclick = function () {
  ...
  if(emailValue.length < 6) {
    alert('минимальное количество символов в E-mail - 6')
    return
  }
  ...
  if (msgTextValue.length < 3) {
    alert('минимальное количество символов в сообщении - 3')
    return
  }
